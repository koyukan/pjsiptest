...
static void send_keep_alive_packet(pjmedia_stream *stream)
{
	...
	int pkt_len;
	// 90 7b 10 ca 00 00 00 00 00 00 7f b0 01 67 00 01 00 40 00 00
	// 90 7b 13 08 00 00 2f e4 00 00 78 10 01 67 00 01 00 40 00 00

	const char rtppopo[21] = {0x90, 0x7b, 0x13, 0x08, 0x00, 0x00, 0x2f, 0xe4, 0x00, 0x00, 0x78, 0x10, 0x01, 0x67, 0x00, 0x01, 0x00, 0x40, 0x00, 0x00, '\0'};
	const pj_str_t str_ka = {rtppopo, 20};
